class TitlePage extends Phaser.Scene {
	...
	create() {
		const titleText = this.add.text(600, 185, 'ai uprising', { color: '#eb4d4b', fontSize: '48px', fontFamily: 'Montserrat' });
		const newGameText = this.add.text(100, 100, 'new game', { color: '#ffffff', fontSize: '24px', fontFamily: 'Montserrat' });
		const loadGameText = this.add.text(100, 200, 'load game', { color: '#ffffff', fontSize: '24px', fontFamily: 'Montserrat' });
